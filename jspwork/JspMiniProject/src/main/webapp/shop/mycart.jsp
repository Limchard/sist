...
<table class="table table-striped" style="width: 1000px;">
	...
	for(int i=0;i<list.size();i++){
		...
		// 사진 -> 아까 map.put() 으로 넣은거는 map.get() 으로 가져오면 된다.
		...
		<tr>
			...
			<td>
				...
				allmoney+=price;
				%>
				<h5><%=nf.format(price) %>&nbsp;<i class="bi bi-trash" idx="<%=map.get("idx")%>" style="color: red; cursor: pointer;"></i></h5>
			</td>
		</tr>
	<%}
	...
	<tr>
		<td colspan="4">
			...
			<span style="font-size: 2em; float: right;">총 주문금액: <b style="color: blue"><%=nf.format(allmoney) %></b></span>
		</td>
	</tr>	
</table>
