...
<img alt="" src="" id="showing" style="position: absolute; left: 800px; top: 100px; max-width: 200px;">
	...
	<form action="guest/addproc.jsp" method="post" enctype="multipart/form-data">
		<table class="table table-bordered" style="width: 600px;">
			<caption align="top">
				<b>방명록 등록</b>
				<i class="bi bi-camera camera" style="font-size: 1.5em; cursor: pointer;"></i>
				<input type="file" name="photo" id="photo" style="visibility: hidden; cursor: pointer;" onchange="readURL(this)">
			</caption>
			<div>
				<select>
					<option onclick="getseq()"></option>
				</select>
			</div>
