...
<body>
	...
	<form action="sessionAction.jsp" method="post">
		...
		<input type="radio" value="대만 3박4일" name="travel">대만 3박4일&nbsp;
		<input type="radio" value="홍콩 3박4일" name="travel">홍콩 3박4일&nbsp;
		<input type="radio" value="서유럽 7박8일" name="travel" checked="checked">서유럽 7박8일&nbsp;
