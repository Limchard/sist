...
<head>
<meta charset="UTF-8">
<link href="https://fonts.googleapis.com/css2?family=Bagel+Fat+One&family=Black+Han+Sans&family=Dongle:wght@300&family=Gamja+Flower&family=Gowun+Dodum&family=Jua&family=Nanum+Gothic+Coding&family=Nanum+Pen+Script&family=Orbit&display=swap" rel="stylesheet">
...
<div>
	...
	<img class="himg" src="../img/map.png">
	...
	<table class="table table-bordered tb" recomname="<%=RecomCourseDto.getName()%>">
		<tr>
			<td rowspan="2" style="width: 200px; padding: 20px;">
				<img alt="" src="../img/sample.jpeg" style="width: 200px;">
			</td>
			<td>
...
$("table.tb").click(function(){
	...
	alert(name);
	location.href="../MyCourse/detailCourse.jsp?name="+name;
