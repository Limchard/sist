...
public class DBConnect {
    ...
    // url
    static final String MYSQL_URL="jdbc:mysql://localhost:3306/semipjt?serverTimezone=Asia/Seoul";
    ...
    public Connection getConnection(){
        ...
        try {
            conn= DriverManager.getConnection(MYSQL_URL,"root","dla570426");



        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println("MySQL 연결실패: url, 계정, 비밀번호 확인 요함 "+e.getMessage());
        }
